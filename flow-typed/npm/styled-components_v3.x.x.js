...
type $npm$styledComponents$Interpolation =
  ...
  | string
  | number
type $npm$styledComponents$NameGenerator = (
  hash: number
) => string
...
type $npm$styledComponents$ReactComponentClass<
  Props,
  DefaultProps = *
> = Class<
...
> =
  ...
  | $npm$styledComponents$ReactComponentClass<
      ...
      DefaultProps
    >
  | $npm$styledComponents$ReactComponentClassUndefinedDefaultProps<
      Props
    >
...
// ---- WITHCOMPONENT ----
type $npm$styledComponents$ReactComponentStyledWithComponent<
  ComponentList
> = <
  Props,
  DefaultProps,
...
> = $npm$styledComponents$ReactComponentStyledStaticPropsWithComponent<
  ...
  ComponentList
> &
  $npm$styledComponents$ReactComponentIntersection<
    Props,
    DefaultProps
  >
...
declare module 'styled-components' {
  ...
  declare export var css: TaggedTemplateLiteral<
    Array<Interpolation>
  >
  declare export var injectGlobal: TaggedTemplateLiteral<
    void
  >
  declare export var keyframes: TaggedTemplateLiteral<
    string
  >
...
declare module 'styled-components/native' {
  ...
  declare export var ThemeProvider: typeof Npm$StyledComponents$ThemeProvider
  declare export default {
    $call: $npm$styledComponents$Call<
      NativeComponentListKeys
    >,
    css: TaggedTemplateLiteral<Array<Interpolation>>,
    ...$npm$styledComponents$StyledComponentsNativeComponentList
